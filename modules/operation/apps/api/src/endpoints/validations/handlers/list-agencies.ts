...
import { type GtfsValidationsAgencyRequest, GtfsValidationsAgencyRequestSchema, type PlansAgencyItem, PlansAgencyItemSchema } from '@tmlmobilidade/go-operation-pckg-types';
