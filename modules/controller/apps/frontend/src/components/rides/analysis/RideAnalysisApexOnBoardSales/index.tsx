...
export function RideAnalysisApexOnBoardSales() {
	...
	const columns: DataTableColumn<SimplifiedApexOnBoardSale>[] = [
		{
			...
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.created_at.label'),
			width: 280,
		},
		{
			accessor: 'stop_id',
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.stop_id.label'),
			width: 100,
		},
		{
			accessor: 'card_serial_number',
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.card_serial_number.label'),
			width: 220,
		},
		{
			accessor: 'product_long_id',
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.product_id.label'),
			width: 250,
		},
		{
			accessor: 'product_quantity',
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.product_quantity.label'),
			width: 80,
		},
		{
			accessor: 'price',
			render: item => <CurrencyTag value={item.price} />,
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.price.label'),
			width: 120,
		},
		{
			accessor: 'payment_method',
			render: item => <ApexPaymentMethodTag value={item.payment_method} />,
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.payment_method.label'),
			width: 180,
		},
		{
			accessor: 'card_physical_type',
			render: item => <ApexCardTypeTag value={item.card_physical_type} />,
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.card_type.label'),
			width: 220,
		},
		{
			accessor: 'validation_id',
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.id_validation.label'),
			width: 400,
		},
		{
			accessor: '_id',
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.id_on_board_sale.label'),
			width: 400,
		},
		{
			accessor: 'on_board_refund_id',
			title: t('controller:rides.analysis.OnBoardSales.Table.columns.id_on_board_refund.label'),
			width: 400,
		},
	];
	...
	return (
		<Collapsible description={t('controller:rides.analysis.OnBoardSales.description')} title={t('controller:rides.analysis.OnBoardSales.title')}>
			{sortedSimplifiedApexOnBoardSales?.length > 0 ? (
				...
				<Section padding="md">
					<NoDataLabel text={t('controller:rides.analysis.OnBoardSales.no_data')} />
				</Section>
			)}
		</Collapsible>
	);
