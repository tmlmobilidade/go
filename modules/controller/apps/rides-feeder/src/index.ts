	...
	try {
		...
		for (const [planIndex, currentPlan] of allPlansDataSorted.entries()) {
			try {
				...
				if (!['2', '4', '8', '15', '16', '21', '41', '42', '43', '44'].includes(currentPlan.gtfs_agency?.agency_id)) {
					Logger.error(`Skip processing: gtfs_agency is '${currentPlan.gtfs_agency?.agency_id}'. Only '2', '4', '8', '15', '16', '21', '41', '42', '43', or '44' are allowed.`);
