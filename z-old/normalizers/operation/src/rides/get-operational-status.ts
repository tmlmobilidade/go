...
import { type OperationalStatus, type UnixTimestamp } from '@tmlmobilidade/go-types-shared';
 ...
 */
export function getOperationalStatus(startTimeScheduled: UnixTimestamp, seenLastAt?: null | UnixTimestamp): OperationalStatus {
	//
