...
import { type RawVehicleEventPtTmlTcbV1, type SimplifiedVehicleEvent } from '@tmlmobilidade/go-types-vehicle-events';
import { roundToInt } from '@tmlmobilidade/utils';

/* * */

export const parseRawVehicleEventPtTmlTcbV1 = (doc: RawVehicleEventPtTmlTcbV1): null | SimplifiedVehicleEvent => {
