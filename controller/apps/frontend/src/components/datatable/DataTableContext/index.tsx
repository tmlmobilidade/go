...
import { createContext, type PropsWithChildren, type RefObject, useCallback, useContext, useEffect, useImperativeHandle, useMemo, useRef, useState } from 'react';
...
export function DataTableContextProvider<T>({ children, columns, records, ref }: PropsWithChildren<DataTableProviderProps<T>>) {
	//
	...
	useImperativeHandle(ref, () => ({
		scrollToIndex: (index: number, offset?: number) => {
			listRef.current?.scrollToIndex({ index: index - offset });
		},
	}));
