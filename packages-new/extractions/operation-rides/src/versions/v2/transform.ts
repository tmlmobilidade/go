...
import { type OperationRidesV2OutputRow, type OperationRidesV2QueryRow } from './types.js';
 ...
 */
export function toOutputRow(row: OperationRidesV2QueryRow, acceptance: null | RideAcceptance): OperationRidesV2OutputRow {
	return {
