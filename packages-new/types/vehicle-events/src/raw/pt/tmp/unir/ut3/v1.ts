...
export const RawVehicleEventPtTmpUnirUt3V1PayloadSchema = z.object({
...
export type RawVehicleEventPtTmpUnirUt3V1Payload = z.infer<typeof RawVehicleEventPtTmpUnirUt3V1PayloadSchema>;

/* * */

export const RawVehicleEventPtTmpUnirUt3V1Schema = RawVehicleEventBaseSchema.extend({
	agency_id: z.literal('OP1VZ'),
	payload: RawVehicleEventPtTmpUnirUt3V1PayloadSchema,
	version: z.literal('pt-tmp-unir-ut3-v1'),
});

export type RawVehicleEventPtTmpUnirUt3V1 = z.infer<typeof RawVehicleEventPtTmpUnirUt3V1Schema>;
