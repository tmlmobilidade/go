...
import { type RawVehicleEventEsCrtmAisa, type SimplifiedVehicleEvent } from '@tmlmobilidade/go-types-vehicle-events';
...
/**
 * Transforms a newly inserted CRTM AISA RawVehicleEvent into a SimplifiedVehicleEvent
 ...
 */
export async function processRawVehicleEvent(change: ChangeStreamDocument<RawVehicleEventEsCrtmAisa>) {
	//
