...
export const RawApexTransactionRefundV30PayloadSchema = z.object({
	...
	loadCorrInfo: z.object({
		corrTickLoadDate: z.string(),
		corrTickLoadMachCode: z.number(),
		corrTickLoadNumbDaily: z.number(),
		corrTransactionId: z.string(),
	}),
	mac: z.object({
	...
	transactionInfo: z.object({
		apexTransactionType: z.literal(6),
