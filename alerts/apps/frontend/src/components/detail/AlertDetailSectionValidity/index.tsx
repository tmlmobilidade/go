		...
		>
			<Section flexDirection="row" gap="md">
				<DateTimePicker
					...
					value={startDate}
					onChange={(date) => {
						alertDetailContext.data.form.setFieldValue('active_period_start_date', getUnixTimestampFromJSDate(date));
					}}
				/>
				<DateTimePicker
					className={styles.datePicker}
					...
					value={endDate}
					onChange={(date) => {
						alertDetailContext.data.form.setFieldValue('active_period_end_date', getUnixTimestampFromJSDate(date));
					}}
				/>
			</Section>
		</Collapsible>
