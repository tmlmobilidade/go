...
import { RideAnalysis, RideAnalysisSummary } from '@tmlmobilidade/types';
 ...
 */
export function testRide(ride: RideNormalized): [boolean, RideAnalysisSummary] {
