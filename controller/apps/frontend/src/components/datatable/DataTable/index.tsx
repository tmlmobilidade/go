...
import { DataTableContextProvider, DataTableHandle } from '@/components/datatable/DataTableContext';
...
export interface DataTableProps<T> {
	...
	/**
	 * A reference to the datatable element.
	 * This is useful for imperative actions like scrolling.
	 */
	ref?: React.RefObject<DataTableHandle>
...
export function DataTable<T>({ records, ref, ...props }: DataTableProps<T>) {
	return (
		<DataTableContextProvider ref={ref} columns={props.columns} records={records}>
