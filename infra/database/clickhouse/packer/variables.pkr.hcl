...
variable "packer_subnet_ocid" {
  ...
  This can be any subnet in your compartment (e.g. from the compute module).
  Run: terraform output -state=../../compute/terraform/terraform.tfstate subnet_id
  Or find it in OCI Console > Networking > Virtual Cloud Networks.
  EOT
}
...
variable "ssh_private_key_path" {
  ...
  # Typically the same as ssh_public_key_path without the .pub extension
  # e.g. if ssh_public_key_path = "C:/Users/User/.ssh/id_rsa.pub"
  #      then ssh_private_key_path = "C:/Users/User/.ssh/id_rsa"
}
