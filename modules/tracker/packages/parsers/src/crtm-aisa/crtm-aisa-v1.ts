...
import { type RawVehicleEventCrtmAisaV1, type SimplifiedVehicleEvent } from '@tmlmobilidade/types';
import { roundToInt } from '@tmlmobilidade/utils';

/* * */

export const parseRawVehicleEventCrtmAisaV1 = (doc: RawVehicleEventCrtmAisaV1): null | SimplifiedVehicleEvent => {
