...
import { Collapsible, DataTable, DataTableColumn } from '@go/ui';
import { useMemo } from 'react';

/* * */

export function RidesDetailVehicleEvents() {
	//
	...
	const sortedVehicleEvents = useMemo(() => {
		return ridesDetailContext.data.vehicle_events.sort((a, b) => a.created_at - b.created_at);
