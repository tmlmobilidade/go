...
| 12 | Extract BaseMap camera synchronization, interactions, and layer composition | in progress | 11 | Camera synchronization and map interactions are isolated behind map-owned hooks; layer composition remains and will be committed separately. |
