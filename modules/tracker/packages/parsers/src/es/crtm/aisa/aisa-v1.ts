...
import { type RawVehicleEventEsCrtmAisaV1, type SimplifiedVehicleEvent } from '@tmlmobilidade/go-types-vehicle-events';
import { roundToInt } from '@tmlmobilidade/utils';

/* * */

export const parseRawVehicleEventEsCrtmAisaV1 = (doc: RawVehicleEventEsCrtmAisaV1): null | SimplifiedVehicleEvent => {
