...
import namespaceSchoolsEs from '@/i18n/namespaces/schools/es.json' with { type: 'json' };
import namespaceSchoolsPt from '@/i18n/namespaces/schools/pt.json' with { type: 'json' };
