 ...
 */
export async function updateStopCoordinatesHandler(request: FastifyRequest<{ Body: { latitude: number, longitude: number }, Params: { id: StopId } }>, reply: FastifyReply<Stop>) {
	//
