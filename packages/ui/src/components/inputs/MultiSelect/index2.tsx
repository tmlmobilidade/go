...
export default function MultiSelect2({ clearable = true, data, description, disabled, error, label, limit, maxHeight, onChange, onPaste, searchable = true, selected, width }: MultiSelectProps) {
