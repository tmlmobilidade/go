...
INSERT INTO eta.daily_rides_waypoints_snapped
SELECT
...
FROM eta.daily_rides_waypoints AS w
INNER JOIN eta.daily_rides     AS d ON w.hashed_trip_id = d.hashed_trip_id
