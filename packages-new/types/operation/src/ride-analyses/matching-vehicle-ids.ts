...
export const RideAnalysisMatchingVehicleIdsSchema = RideAnalysisBaseSchema.extend({
	extra_apex_vehicle_ids_qty: NonNegativeNumberSchema.nullable().default(null),
	extra_vehicle_events_vehicle_ids_qty: NonNegativeNumberSchema.nullable().default(null),
	matching_vehicle_ids_qty: NonNegativeNumberSchema.nullable().default(null),
	reason: z.enum(['MATCHING_VEHICLE_IDS', 'VEHICLE_ID_MISMATCH', 'NO_VEHICLE_EVENTS', 'NO_APEX_TRANSACTIONS']).nullable().default(null),
	total_vehicle_ids_qty: NonNegativeNumberSchema.nullable().default(null),
});
