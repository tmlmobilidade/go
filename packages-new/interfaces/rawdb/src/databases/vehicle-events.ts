...
export class VehicleEventsDatabase {
	...
	public constructor(instance: MongoClient) {
		...
		this.esCrtmAisa = new MongoInterfaceTemplate<RawVehicleEventEsCrtmAisa, RawVehicleEventEsCrtmAisa>('es-crtm-aisa', this.database, RawVehicleEventEsCrtmAisaSchema);
		this.esCrtmLaVeloz = new MongoInterfaceTemplate<RawVehicleEventEsCrtmLaVeloz, RawVehicleEventEsCrtmLaVeloz>('es-crtm-la-veloz', this.database, RawVehicleEventEsCrtmLaVelozSchema);
		this.ptTmlCcfl = new MongoInterfaceTemplate<RawVehicleEventPtTmlCcfl, RawVehicleEventPtTmlCcfl>('pt-tml-ccfl', this.database, RawVehicleEventPtTmlCcflSchema);
		this.ptTmlCmAlsa = new MongoInterfaceTemplate<RawVehicleEventPtTmlCmAlsa, RawVehicleEventPtTmlCmAlsa>('pt-tml-cm-alsa', this.database, RawVehicleEventPtTmlCmAlsaSchema);
		this.ptTmlCmRl = new MongoInterfaceTemplate<RawVehicleEventPtTmlCmRl, RawVehicleEventPtTmlCmRl>('pt-tml-cm-rl', this.database, RawVehicleEventPtTmlCmRlSchema);
		this.ptTmlCmTst = new MongoInterfaceTemplate<RawVehicleEventPtTmlCmTst, RawVehicleEventPtTmlCmTst>('pt-tml-cm-tst', this.database, RawVehicleEventPtTmlCmTstSchema);
		this.ptTmlCmVa = new MongoInterfaceTemplate<RawVehicleEventPtTmlCmVa, RawVehicleEventPtTmlCmVa>('pt-tml-cm-va', this.database, RawVehicleEventPtTmlCmVaSchema);
		this.ptTmlCp = new MongoInterfaceTemplate<RawVehicleEventPtTmlCp, RawVehicleEventPtTmlCp>('pt-tml-cp', this.database, RawVehicleEventPtTmlCpSchema);
		this.ptTmlFertagus = new MongoInterfaceTemplate<RawVehicleEventPtTmlFertagus, RawVehicleEventPtTmlFertagus>('pt-tml-fertagus', this.database, RawVehicleEventPtTmlFertagusSchema);
		this.ptTmlMl = new MongoInterfaceTemplate<RawVehicleEventPtTmlMl, RawVehicleEventPtTmlMl>('pt-tml-ml', this.database, RawVehicleEventPtTmlMlSchema);
		this.ptTmlMobi = new MongoInterfaceTemplate<RawVehicleEventPtTmlMobi, RawVehicleEventPtTmlMobi>('pt-tml-mobi', this.database, RawVehicleEventPtTmlMobiSchema);
		this.ptTmlTcb = new MongoInterfaceTemplate<RawVehicleEventPtTmlTcb, RawVehicleEventPtTmlTcb>('pt-tml-tcb', this.database, RawVehicleEventPtTmlTcbSchema);
		this.ptTmlTtsl = new MongoInterfaceTemplate<RawVehicleEventPtTmlTtsl, RawVehicleEventPtTmlTtsl>('pt-tml-ttsl', this.database, RawVehicleEventPtTmlTtslSchema);
		this.ptTmpUnirUt1 = new MongoInterfaceTemplate<RawVehicleEventPtTmpUnirUt1, RawVehicleEventPtTmpUnirUt1>('pt-tmp-unir-ut1', this.database, RawVehicleEventPtTmpUnirUt1Schema);
		this.ptTmpUnirUt2 = new MongoInterfaceTemplate<RawVehicleEventPtTmpUnirUt2, RawVehicleEventPtTmpUnirUt2>('pt-tmp-unir-ut2', this.database, RawVehicleEventPtTmpUnirUt2Schema);
		this.ptTmpUnirUt3 = new MongoInterfaceTemplate<RawVehicleEventPtTmpUnirUt3, RawVehicleEventPtTmpUnirUt3>('pt-tmp-unir-ut3', this.database, RawVehicleEventPtTmpUnirUt3Schema);
		this.ptTmpUnirUt4 = new MongoInterfaceTemplate<RawVehicleEventPtTmpUnirUt4, RawVehicleEventPtTmpUnirUt4>('pt-tmp-unir-ut4', this.database, RawVehicleEventPtTmpUnirUt4Schema);
		this.ptTmpUnirUt5 = new MongoInterfaceTemplate<RawVehicleEventPtTmpUnirUt5, RawVehicleEventPtTmpUnirUt5>('pt-tmp-unir-ut5', this.database, RawVehicleEventPtTmpUnirUt5Schema);
		this.ptTmpUnirUt6 = new MongoInterfaceTemplate<RawVehicleEventPtTmpUnirUt6, RawVehicleEventPtTmpUnirUt6>('pt-tmp-unir-ut6', this.database, RawVehicleEventPtTmpUnirUt6Schema);
	}
}
