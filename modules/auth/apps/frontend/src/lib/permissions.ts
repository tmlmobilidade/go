...
const rideActions: PermissionConfig = {
	actions: [
		...
		{ action: 'acceptance_payment_request', description: 'Permite alterar o estado de pagamento de uma viagem', label: 'Aceitação - Alterar estado de pagamento', resources: ['AGENCIES'] },
	],
