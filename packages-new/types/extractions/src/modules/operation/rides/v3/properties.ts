 ...
 */
export const OperationRidesV3ExtractionPropertiesSchema = z.object({
...
export type OperationRidesV3ExtractionProperties = z.infer<typeof OperationRidesV3ExtractionPropertiesSchema>;
