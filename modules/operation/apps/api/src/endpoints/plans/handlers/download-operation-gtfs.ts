...
/**
 * Download the operation GTFS file associated with a plan by ID.
 * @param request The request object.
 * @param reply The reply object.
 */
export async function downloadOperationGtfsHandler(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply<string>) {
	//
