...
import { ParsedTransactionEntityV2, RawApexValidationV20, type SimplifiedApexValidation } from '@tmlmobilidade/types';
...
export function parseApexValidationV20(txEntity: ParsedTransactionEntityV2): null | SimplifiedApexValidation {
	try {
		//
