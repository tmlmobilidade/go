...
import { CreateLineDto, INTERCHANGE_MODE, transportTypeMapper, Typology } from '@tmlmobilidade/go-types-offer';
 ...
 */
export function resolveLineCode(route: GtfsStrictV29Routes): string {
	return String(route.line_id).trim();
}

export function buildLineFromRoute(route: GtfsStrictV29Routes, agencyId: string, typologyMap: Map<string, Typology>, routeColor?: string, interchangeMode?: typeof INTERCHANGE_MODE[keyof typeof INTERCHANGE_MODE]): CreateLineDto {
