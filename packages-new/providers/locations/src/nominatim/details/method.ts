...
import { type NominatimDetailsRequest, NominatimDetailsRequestSchema } from './details-request.js';
import { type NominatimDetailsResponse, NominatimDetailsResponseSchema } from './details-response.js';
 ...
 */
export async function details(params: NominatimDetailsRequest): Promise<NominatimDetailsResponse> {
	//
