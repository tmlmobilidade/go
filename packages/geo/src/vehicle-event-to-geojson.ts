 ...
 */
export function transformVehicleDataIntoGeoJsonFeature<T extends HubV1ApiVehiclePosition | SimplifiedVehicleEvent>(event: T, vehicleData?: Vehicle): GeoJSON.Feature<GeoJSON.Point, Partial<Vehicle> & T> {
	return {
		geometry: {
