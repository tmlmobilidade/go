...
import { type RawVehicleEventEsCrtmLaVelozV1, type SimplifiedVehicleEvent } from '@tmlmobilidade/go-types-vehicle-events';
import { roundToInt } from '@tmlmobilidade/utils';

/* * */

export const parseRawVehicleEventEsCrtmLaVelozV1 = (doc: RawVehicleEventEsCrtmLaVelozV1): null | SimplifiedVehicleEvent => {
