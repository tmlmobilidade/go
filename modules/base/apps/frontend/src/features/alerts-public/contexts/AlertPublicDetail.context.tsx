...
import { getAvailableLines } from '@/features/alerts-public/lib/alert-utils';
...
export function AlertPublicDetailContextProvider({ alertId, children }: PropsWithChildren<{ alertId: string }>) {
