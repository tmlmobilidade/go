...
export const RawVehicleEventPtTmpUnirUt1V1PayloadSchema = z.object({
...
export type RawVehicleEventPtTmpUnirUt1V1Payload = z.infer<typeof RawVehicleEventPtTmpUnirUt1V1PayloadSchema>;

/* * */

export const RawVehicleEventPtTmpUnirUt1V1Schema = RawVehicleEventBaseSchema.extend({
	agency_id: z.literal('KJTOU'),
	payload: RawVehicleEventPtTmpUnirUt1V1PayloadSchema,
	version: z.literal('pt-tmp-unir-ut1-v1'),
});

export type RawVehicleEventPtTmpUnirUt1V1 = z.infer<typeof RawVehicleEventPtTmpUnirUt1V1Schema>;
