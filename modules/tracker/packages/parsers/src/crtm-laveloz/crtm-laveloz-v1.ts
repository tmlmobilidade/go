...
import { type RawVehicleEventCrtmLaVelozV1, type SimplifiedVehicleEvent } from '@tmlmobilidade/types';
import { roundToInt } from '@tmlmobilidade/utils';

/* * */

export const parseRawVehicleEventCrtmLaVelozV1 = (doc: RawVehicleEventCrtmLaVelozV1): null | SimplifiedVehicleEvent => {
