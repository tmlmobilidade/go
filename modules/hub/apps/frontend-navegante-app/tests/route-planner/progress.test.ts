...
import { getMotisItineraryActiveLegIndex, getMotisLegRemainingDistanceMeters, getMotisLegRemainingSeconds, getRoutePlannerActiveLegProgress } from '@/utils/route-planner/itinerary/progress';
