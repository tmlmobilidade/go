...
import { type RawVehicleEventPtTmlCmAlsa, type SimplifiedVehicleEvent } from '@tmlmobilidade/go-types-vehicle-events';
...
/**
 * Transforms a newly inserted CM ALSA RawVehicleEvent into a SimplifiedVehicleEvent
 ...
 */
export async function processRawVehicleEvent(change: ChangeStreamDocument<RawVehicleEventPtTmlCmAlsa>) {
	//
