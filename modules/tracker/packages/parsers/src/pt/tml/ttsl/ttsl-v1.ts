...
import { type RawVehicleEventPtTmlTtslV1, type SimplifiedVehicleEvent } from '@tmlmobilidade/go-types-vehicle-events';
import { roundToInt } from '@tmlmobilidade/utils';

/* * */

export const parseRawVehicleEventPtTmlTtslV1 = (doc: RawVehicleEventPtTmlTtslV1): null | SimplifiedVehicleEvent => {
