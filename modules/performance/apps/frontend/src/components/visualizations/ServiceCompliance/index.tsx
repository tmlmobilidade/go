...
export function ServiceCompliance({ agency }: { agency?: AgencyType }) {
	...
	const metricsData = [
		{
			...
			title: t('performance:visualizations.ServiceCompliance.Metrics.with_sales'),
		...
		},
		{
			...
			title: t('performance:visualizations.ServiceCompliance.Metrics.no_passengers'),
			totalValue: formattedData.scheduledRides,
		...
		},
		{
			...
			title: t('performance:visualizations.ServiceCompliance.Metrics.delayed'),
			totalValue: formattedData.scheduledRides,
		...
		},
		{
			...
			title: t('performance:visualizations.ServiceCompliance.Metrics.advanced'),
			totalValue: formattedData.scheduledRides,
	...
	return (
		<MetricCard goal="increase" icon={<IconBus />} isLoading={isLoading} previousValue={formattedData.accomplishedRides.last_week} title={t('performance:visualizations.ServiceCompliance.title')} updatedAt={formattedData.lastUpdated} value={formattedData.accomplishedRides.now}>
			<div className={styles.cardsContainer}>
				...
				<div style={{ alignItems: 'center', display: 'flex', flexDirection: 'column', gap: '16px' }}>
					...
					/>
					<p style={{ textAlign: 'center', width: '250px' }}>{t('performance:visualizations.ServiceCompliance.valid_pct_label')}</p>
				</div>
