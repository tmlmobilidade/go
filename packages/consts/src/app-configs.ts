...
const APP_CONFIGS: Record<string, Record<Environment, AppConfigGroup>> = {
	...
	alerts: {
		...
		production: {
			api_url: 'https://go.carrismetropolitana.pt/alerts/api',
			frontend_url: 'https://go.carrismetropolitana.pt/alerts',
			...DEFAULT_NON_DEV_CONFIG,
		},
		staging: {
			api_url: 'https://staging.go.carrismetropolitana.pt/alerts/api',
			frontend_url: 'https://staging.go.carrismetropolitana.pt/alerts',
			...DEFAULT_NON_DEV_CONFIG,
		},
	},
	...
	controller: {
		...
		production: {
			api_url: 'https://go.carrismetropolitana.pt/controller/api',
			frontend_url: 'https://go.carrismetropolitana.pt/controller',
			...DEFAULT_NON_DEV_CONFIG,
		},
		staging: {
			api_url: 'https://staging.go.carrismetropolitana.pt/controller/api',
			frontend_url: 'https://staging.go.carrismetropolitana.pt/controller',
			...DEFAULT_NON_DEV_CONFIG,
		},
	},
	...
	locations: {
		...
		production: {
			api_url: 'https://go.carrismetropolitana.pt/locations/api',
			frontend_url: 'https://go.carrismetropolitana.pt/locations',
			...DEFAULT_NON_DEV_CONFIG,
		},
		staging: {
			api_url: 'https://staging.go.carrismetropolitana.pt/locations/api',
			frontend_url: 'https://staging.go.carrismetropolitana.pt/locations',
			...DEFAULT_NON_DEV_CONFIG,
		},
	},
	...
	performance: {
		...
		production: {
			api_url: 'https://go.carrismetropolitana.pt/performance/api',
			frontend_url: 'https://go.carrismetropolitana.pt/performance',
			...DEFAULT_NON_DEV_CONFIG,
		},
		staging: {
			api_url: 'https://staging.go.carrismetropolitana.pt/performance/api',
			frontend_url: 'https://staging.go.carrismetropolitana.pt/performance',
			...DEFAULT_NON_DEV_CONFIG,
		},
	},
	...
	plans: {
		...
		production: {
			api_url: 'https://go.carrismetropolitana.pt/plans/api',
			frontend_url: 'https://go.carrismetropolitana.pt/plans',
			...DEFAULT_NON_DEV_CONFIG,
		},
		staging: {
			api_url: 'https://staging.go.carrismetropolitana.pt/plans/api',
			frontend_url: 'https://staging.go.carrismetropolitana.pt/plans',
			...DEFAULT_NON_DEV_CONFIG,
		},
	},
	...
	stops: {
		...
		production: {
			api_url: 'https://go.carrismetropolitana.pt/stops/api',
			frontend_url: 'https://go.carrismetropolitana.pt/stops',
			...DEFAULT_NON_DEV_CONFIG,
		},
		staging: {
			api_url: 'https://staging.go.carrismetropolitana.pt/stops/api',
			frontend_url: 'https://staging.go.carrismetropolitana.pt/stops',
			...DEFAULT_NON_DEV_CONFIG,
		},
	},
