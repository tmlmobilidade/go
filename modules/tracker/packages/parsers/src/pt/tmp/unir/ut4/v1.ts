...
import { type RawVehicleEventPtTmpUnirUt4V1, type SimplifiedVehicleEvent, SimplifiedVehicleEventSchema } from '@tmlmobilidade/go-types-vehicle-events';

/* * */

export function parseRawVehicleEventPtTmpUnirUt4V1(doc: RawVehicleEventPtTmpUnirUt4V1): null | SimplifiedVehicleEvent {
