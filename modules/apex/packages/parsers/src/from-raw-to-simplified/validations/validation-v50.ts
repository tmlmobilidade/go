...
import { type RawApexTransactionValidationV50, type SimplifiedApexValidation } from '@tmlmobilidade/go-types-apex';

/* * */

export function parseRawApexTransactionValidationV50(doc: RawApexTransactionValidationV50): null | SimplifiedApexValidation {
	try {
		//
