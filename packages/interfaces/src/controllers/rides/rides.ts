...
import { GetRidesBatchQuery, GetRidesBatchQuerySchema } from '@/controllers/rides/schema.js';
import { ridesBatchAggregationPipeline } from '@/interfaces/rides/pipelines.js';
import { rides } from '@/interfaces/rides/rides.js';
