...
export const SQL_FILES = {
	hub: [
		...
		'eta/bootstrap/migrate-2026-09-eta-loader-p0.sql',
		...
		'eta/cleanup/2-delete-orphan-curr-waypoints.sql',
		'eta/cleanup/3-delete-out-of-window-hist-rides.sql',
		'eta/cleanup/4-list-out-of-window-hist-node-travel-times-partitions.sql',
		'eta/cleanup/5-delete-out-of-window-hist-node-travel-times-aggregation.sql',
		'eta/cleanup/6-delete-orphan-hist-shape-nodes.sql',
		...
		'publish-eta/select-eta-by-stop-gtfs.sql',
		'publish-eta/select-eta-by-stop.sql',
		'publish-eta/select-eta-by-trip-gtfs.sql',
