...
export const GtfsStrictAgencySchema = GtfsAgencySchema.extend({
...
/**
 * Represents an agency in the custom GTFS strict format.
 ...
 */
export type GtfsStrictAgency = z.infer<typeof GtfsStrictAgencySchema>;
