...
import { type PcgiTransactionEntity, type RawApexTransaction, type RawApexTransactionInspectionDecisionV20, RawApexTransactionInspectionDecisionV20PayloadSchema, RawApexTransactionInspectionDecisionV20Schema } from '@tmlmobilidade/go-types-apex';
