...
interface FlatRide {
	...
	headsign: string
	highest_vehicle_event_delay_grade: string
	// highest_vehicle_event_delay_message: null | string
	highest_vehicle_event_delay_reason: null | string
	// highest_vehicle_event_delay_unit: null | string
	highest_vehicle_event_delay_value: null | number
	is_locked: boolean
...
const sampleRide: FlatRide = {
	...
	headsign: 'string',
	highest_vehicle_event_delay_grade: 'string',
	highest_vehicle_event_delay_reason: 'string',
	highest_vehicle_event_delay_value: 0,
	is_locked: false,
	less_than_ten_vehicle_events_grade: 'string',
...
function parseRide(ride: Ride): FlatRide {
	return {
		...
		highest_vehicle_event_delay_grade: ride.analysis?.HIGHEST_VEHICLE_EVENT_DELAY?.grade ?? null,
		highest_vehicle_event_delay_reason: ride.analysis?.HIGHEST_VEHICLE_EVENT_DELAY?.reason ?? null,
		highest_vehicle_event_delay_value: ride.analysis?.HIGHEST_VEHICLE_EVENT_DELAY?.value ?? null,
