/* eslint-disable */
// This file is auto-generated by @hey-api/openapi-ts from MOTIS v2.10.2 OpenAPI.
...
export const RouteSchema = {
    description: 'a transit route/line serving a stop',
    type: 'object',
    required: ['routeId', 'routeShortName', 'routeLongName', 'mode', 'agencyId', 'agencyName', 'agencyUrl'],
    properties: {
        routeId: {
            type: 'string'
        },
