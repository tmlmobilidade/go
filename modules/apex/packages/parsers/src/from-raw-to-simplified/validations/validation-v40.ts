...
import { type RawApexTransactionValidationV40, type SimplifiedApexValidation } from '@tmlmobilidade/go-types-apex';

/* * */

export function parseRawApexTransactionValidationV40(doc: RawApexTransactionValidationV40): null | SimplifiedApexValidation {
	try {
		//
