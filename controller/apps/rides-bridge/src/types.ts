...
export function parseRide(ride: Ride): FlatRide {
	return {
		...
		at_least_one_event_on_first_stop_grade: ride.analysis?.AT_LEAST_ONE_VEHICLE_EVENT_ON_FIRST_STOP?.grade ?? null,
		at_least_one_event_on_first_stop_reason: ride.analysis?.AT_LEAST_ONE_VEHICLE_EVENT_ON_FIRST_STOP?.reason ?? null,
		at_least_one_event_on_first_stop_value: ride.analysis?.AT_LEAST_ONE_VEHICLE_EVENT_ON_FIRST_STOP?.value ?? null,
		at_most_two_driver_ids_grade: ride.analysis?.EXPECTED_DRIVER_ID_QTY?.grade ?? null,
		at_most_two_driver_ids_reason: ride.analysis?.EXPECTED_DRIVER_ID_QTY?.reason ?? null,
		at_most_two_driver_ids_value: ride.analysis?.EXPECTED_DRIVER_ID_QTY?.value ?? null,
		at_most_two_vehicle_ids_grade: ride.analysis?.EXPECTED_VEHICLE_ID_QTY?.grade ?? null,
		at_most_two_vehicle_ids_reason: ride.analysis?.EXPECTED_VEHICLE_ID_QTY?.reason ?? null,
		at_most_two_vehicle_ids_value: ride.analysis?.EXPECTED_VEHICLE_ID_QTY?.value ?? null,
		avg_interval_vehicle_events_grade: ride.analysis?.EXPECTED_VEHICLE_EVENT_INTERVAL?.grade ?? null,
		avg_interval_vehicle_events_reason: ride.analysis?.EXPECTED_VEHICLE_EVENT_INTERVAL?.reason ?? null,
		avg_interval_vehicle_events_value: ride.analysis?.EXPECTED_VEHICLE_EVENT_INTERVAL?.value ?? null,
		created_at: ride.created_at,
		driver_ids: (ride.driver_ids ?? []).join('|'),
		end_time_observed: ride.end_time_observed,
		end_time_scheduled: ride.end_time_scheduled,
		excessive_vehicle_event_delay_grade: ride.analysis?.EXPECTED_VEHICLE_EVENT_DELAY?.grade ?? null,
		excessive_vehicle_event_delay_reason: ride.analysis?.EXPECTED_VEHICLE_EVENT_DELAY?.reason ?? null,
		excessive_vehicle_event_delay_value: ride.analysis?.EXPECTED_VEHICLE_EVENT_DELAY?.value ?? null,
		...
		is_locked: false,
		less_than_ten_vehicle_events_grade: ride.analysis?.EXPECTED_VEHICLE_EVENT_QTY?.grade ?? null,
		less_than_ten_vehicle_events_reason: ride.analysis?.EXPECTED_VEHICLE_EVENT_QTY?.reason ?? null,
		less_than_ten_vehicle_events_value: ride.analysis?.EXPECTED_VEHICLE_EVENT_QTY?.found_qty ?? null,
		line_id: ride.line_id,
		matching_location_transactions_grade: ride.analysis?.MATCHING_APEX_LOCATIONS?.grade ?? null,
		matching_location_transactions_reason: ride.analysis?.MATCHING_APEX_LOCATIONS?.reason ?? null,
		matching_location_transactions_value: null,
		ontime_start_grade: ride.analysis?.EXPECTED_START_TIME?.grade ?? null,
		ontime_start_reason: ride.analysis?.EXPECTED_START_TIME?.reason ?? null,
		ontime_start_value: ride.analysis?.EXPECTED_START_TIME?.value ?? null,
		...
		simple_one_validation_transaction_grade: ride.analysis?.SIMPLE_ONE_APEX_VALIDATION?.grade ?? null,
		simple_one_validation_transaction_reason: ride.analysis?.SIMPLE_ONE_APEX_VALIDATION?.reason ?? null,
		simple_one_validation_transaction_value: ride.analysis?.SIMPLE_ONE_APEX_VALIDATION?.value ?? null,
		simple_one_vehicle_event_or_validation_transaction_grade: ride.analysis?.SIMPLE_ONE_VEHICLE_EVENT_OR_APEX_VALIDATION?.grade ?? null,
		simple_one_vehicle_event_or_validation_transaction_reason: ride.analysis?.SIMPLE_ONE_VEHICLE_EVENT_OR_APEX_VALIDATION?.reason ?? null,
		simple_one_vehicle_event_or_validation_transaction_value: null,
		...
		simple_three_vehicle_events_value: null,
		...
		transaction_sequentiality_value: ride.analysis?.TRANSACTION_SEQUENTIALITY?.missing_qty ?? null,
