...
const planActions: PermissionConfig<typeof Permissions.plans.actions> = {
	actions: [
		...
		{ description: 'Permite editar o controlador de um plano', key: 'update_controller', label: 'Editar Controller', resources: ['AGENCIES'] },
		...
		{ description: 'Permite editar o PCGI legado de um plano', key: 'update_pcgi_legacy', label: 'Editar PCGI Legacy', resources: ['AGENCIES'] },
