...
import { transformVehicleEventForClickHouse } from '@tmlmobilidade/go-apex-pckg-parse';
import { getEarliestDate, syncToClickHouse } from '@tmlmobilidade/go-apex-pckg-sync';
