...
export function useDataSimplifiedUser(props?: UseDataSimplifiedUserProps): UseDataSimplifiedUserReturnType {
	...
	const { data: simplifiedUserData, error: simplifiedUserError, isLoading: simplifiedUserLoading } = useSWR<SimplifiedUser, Error>(props._id && props._id !== 'system' && API_ROUTES.core.USERS_DETAIL_SIMPLIFIED(props._id));
