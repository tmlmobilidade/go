...
PRIMARY_HOST="sae-db-rs0-1-staging.carrismetropolitana.pt"
SECONDARY_HOST1="sae-db-rs0-2-staging.carrismetropolitana.pt"
SECONDARY_HOST2="sae-db-rs0-3-staging.carrismetropolitana.pt"
