...
/**
 * NUQS parser for an array of strings with the special case of 'none'.
 * Handles parsing, serialization, and equality checking for filters
 * that accept multiple string values with the special case of 'none'.
 */
export const parseAsArrayOfStringsWithNone = createParser({ eq: eqFn, parse: parseFn, serialize: serializeFn });
