...
func (rp *RulesParser) validateRules(rules *types.GtfsRules) error {
	...
	if rules.FileValidation.File != types.SEVERITY_FORBIDDEN && rules.FileValidation.File != "" {
		validateRuleConfig(rules.FileValidation.GtfsFeedFilePresenceAndIntegrity, "file_validation.file_validation_gtfs_feed_file_presence_and_integrity_rule")
	}
	...
	if rules.RiderCategories.File != types.SEVERITY_FORBIDDEN {
		...
		validateRuleConfig(rules.RiderCategories.IsDefaultFareCategory, "rider_categories.rider_categories_at_most_one_default_fare_category")
		validateRuleConfig(rules.RiderCategories.EligibilityUrl, "rider_categories.rider_categories_eligibility_url_valid_http_url")
	}
	...
	if rules.Stops.File != types.SEVERITY_FORBIDDEN {
		...
		validateRuleConfig(rules.Stops.TtsStopName, "stops.stops_tts_stop_name_valid")
		...
		validateRuleConfig(rules.Stops.ZoneId, "stops.stops_zone_id_valid")
		validateRuleConfig(rules.Stops.StopUrl, "stops.stop_url_valid_url")
		validateRuleConfig(rules.Stops.LocationType, "stops.stops_location_type_valid_enum")
		validateRuleConfig(rules.Stops.ParentStation, "stops.stops_parent_station_id_valid_for_stop_hierarchy")
		validateRuleConfig(rules.Stops.StopTimezone, "stops.stop_timezone_valid")
		validateRuleConfig(rules.Stops.WheelchairBoarding, "stops.stops_wheelchair_boarding_valid_enum")
		validateRuleConfig(rules.Stops.LevelId, "stops.stops_level_id_valid_id")
		validateRuleConfig(rules.Stops.PlatformCode, "stops.stops_platform_code_valid")
		validateRuleConfig(rules.Stops.PublicVisible, "stops.stops_public_visible_valid_enum")
		validateRuleConfig(rules.Stops.HasStopSign, "stops.stops_has_stop_sign_valid_enum")
		validateRuleConfig(rules.Stops.HasShelter, "stops.stops_has_shelter_valid_enum")
		validateRuleConfig(rules.Stops.ShelterCode, "stops.stops_shelter_code_valid")
		validateRuleConfig(rules.Stops.ShelterMaintainer, "stops.stops_shelter_maintainer_valid")
		validateRuleConfig(rules.Stops.HasBench, "stops.stops_has_bench_valid_enum")
		validateRuleConfig(rules.Stops.HasNetworkMap, "stops.stops_has_network_map_valid_enum")
		validateRuleConfig(rules.Stops.HasSchedules, "stops.stops_has_schedules_valid_enum")
		validateRuleConfig(rules.Stops.HasPipRealTime, "stops.stops_has_pip_real_time_valid_enum")
		validateRuleConfig(rules.Stops.HasTariffsInformation, "stops.stops_has_tariffs_information_valid_enum")
		validateRuleConfig(rules.Stops.RegionId, "stops.stops_region_id_valid")
		validateRuleConfig(rules.Stops.MunicipalityId, "stops.stops_municipality_id_valid")
		validateRuleConfig(rules.Stops.ParishId, "stops.stops_parish_id_valid")
	}
	...
	if rules.Routes.File != types.SEVERITY_FORBIDDEN {
		...
		validateRuleConfig(rules.Routes.ContinuousPickup, "routes.routes_continuous_pickup_valid_gtfs_enum")
		validateRuleConfig(rules.Routes.ContinuousDropOff, "routes.routes_continuous_drop_off_valid_gtfs_enum")
	}

	// Add validation for other rule types (trips, stop_times, calendar, etc.)
	if rules.Trips.File != types.SEVERITY_FORBIDDEN {
		validateRuleConfig(rules.Trips.RouteId, "trips.trips_route_id_references_routes_table")
		validateRuleConfig(rules.Trips.PatternId, "trips.trips_pattern_id_present_and_references_consistent")
		validateRuleConfig(rules.Trips.ServiceId, "trips.trips_service_id_references_calendar_service")
		...
		validateRuleConfig(rules.Trips.DirectionId, "trips.trips_direction_id_valid_enum")
		validateRuleConfig(rules.Trips.BlockId, "trips.trips_block_id_in_allowed_set")
		validateRuleConfig(rules.Trips.ShapeId, "trips.trips_shape_id_references_shapes_table_when_present")
		validateRuleConfig(rules.Trips.WheelchairAccessible, "trips.trips_wheelchair_accessible_valid_gtfs_enum")
		validateRuleConfig(rules.Trips.BikesAllowed, "trips.trips_bikes_allowed_valid_gtfs_enum")
		validateRuleConfig(rules.Trips.StopSequence, "trips.trips_stop_sequence_increasing_by_one_along_trip")
		validateRuleConfig(rules.Trips.DirectionPatternIdMatch, "trips.trips_direction_id_matches_feed_pattern_direction")
		validateRuleConfig(rules.Trips.TripIdLimitCharacters, "trips.trip_id_limit_max_length")
		validateRuleConfig(rules.Trips.PatternIdFormat, "trips.trips_pattern_id_matches_feed_pattern_id_syntax")
		validateRuleConfig(rules.Trips.StopCoordinatesByTripId, "trips.trip_path_stop_coordinates_referenced_from_stops")
		validateRuleConfig(rules.Trips.PatternIdTripHasRequiredFieldsForGrouping, "trips.trips_pattern_id_trip_has_required_fields_for_grouping")
		validateRuleConfig(rules.Trips.PatternIdSingleTripSignaturePerPattern, "trips.trips_pattern_id_single_trip_signature_per_pattern")
		validateRuleConfig(rules.Trips.RouteIdGroup, "trips.trips_route_id_consistent_for_all_patterns_in_trips")
		validateRuleConfig(rules.Trips.DirectionIdGroup, "trips.trips_direction_id_consistent_for_all_patterns_in_trips")
		validateRuleConfig(rules.Trips.OneShapeIdPerPatternIdGroup, "trips.trips_one_shape_id_per_pattern_id_group")
		validateRuleConfig(rules.Trips.OnePatternIdPerShapeIdGroup, "trips.trips_one_pattern_id_per_shape_id_group")
		validateRuleConfig(rules.Trips.TripHeadsignGroup, "trips.trip_headsign_consistent_for_all_patterns_in_trips")
		validateRuleConfig(rules.Trips.ShapeIdSamePatternId, "trips.trips_shape_id_needs_to_be_the_same_as_pattern_id")
	}
	...
	if rules.StopTimes.File != types.SEVERITY_FORBIDDEN {
		...
		validateRuleConfig(rules.StopTimes.ArrivalTime, "stop_times.stop_times_arrival_time_ordering_with_departure_and_frequencies")
		validateRuleConfig(rules.StopTimes.DepartureTime, "stop_times.stop_times_departure_time_ordering_with_arrival_and_timepoint")
		validateRuleConfig(rules.StopTimes.ArrivalDepartureSequence, "stop_times.stop_times_arrival_departure_time_non_decreasing_by_stop_sequence")
		validateRuleConfig(rules.StopTimes.StopId, "stop_times.stop_times_stop_id_references_stops_table")
		validateRuleConfig(rules.StopTimes.StopHeadsign, "stop_times.stop_times_stop_headsign_present")
		validateRuleConfig(rules.StopTimes.PickupType, "stop_times.stop_times_pickup_type_valid_gtfs_enum")
		validateRuleConfig(rules.StopTimes.DropOffType, "stop_times.stop_times_drop_off_type_valid_gtfs_enum")
		...
		validateRuleConfig(rules.StopTimes.StartPickupDropOffWindow, "stop_times.stop_times_start_pickup_drop_off_window_valid")
		validateRuleConfig(rules.StopTimes.EndPickupDropOffWindow, "stop_times.stop_times_end_pickup_drop_off_window_valid")
		validateRuleConfig(rules.StopTimes.Timepoint, "stop_times.stop_times_timepoint_valid_gtfs_enum")
		validateRuleConfig(rules.StopTimes.PickupBookingRuleId, "stop_times.stop_times_pickup_booking_rule_id_references_booking_rules")
		validateRuleConfig(rules.StopTimes.DropOffBookingRuleId, "stop_times.stop_times_drop_off_booking_rule_id_references_booking_rules_or_empty")
		validateRuleConfig(rules.StopTimes.LocationGroupId, "stop_times.stop_times_location_group_id_consistent_with_trip_id_and_stops")
	}
	...
	if rules.FeedInfo.File != types.SEVERITY_FORBIDDEN {
		...
		validateRuleConfig(rules.FeedInfo.DefaultLang, "feed_info.feed_info_default_lang_matches_feed_lang_when_present")
	...
	if rules.FareAttributes.File != types.SEVERITY_FORBIDDEN {
		...
		validateRuleConfig(rules.FareAttributes.Transfers, "fare_attributes.fare_attributes_transfers_valid_gtfs_enum")
		validateRuleConfig(rules.FareAttributes.AgencyId, "fare_attributes.fare_attributes_agency_id_references_agency_table")
		validateRuleConfig(rules.FareAttributes.TransferDuration, "fare_attributes.fare_attributes_transfer_duration_valid_seconds_range")
	}
