...
import type { Stop as GtfsStopsExtended } from '@tmlmobilidade/go-navegante-shared-types';
...
import { NetworkStop, StopOperationalStatus } from '@tmlmobilidade/go-navegante-shared-types';
