 ...
 */
export function getDistanceBetweenPoints(pointA: GeoJsonPointGeometry, pointB: GeoJsonPointGeometry): number {
 ...
 * @returns The distance between the two points, in meters.
 */
export function getDistanceBetweenPositions(positionA: GeoJsonPosition, positionB: GeoJsonPosition): number {
