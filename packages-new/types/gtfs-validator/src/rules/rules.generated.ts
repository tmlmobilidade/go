...
export const ruleCatalogue: readonly RuleCatalogueEntry[] = [
	...
	},
	{
		...
		depends_on: ['attributions_file_present'],
		editable: true,
		group: 'attributions',
		id: 'agency_id',
	},
	...
	},
	{
		...
		depends_on: ['calendar_dates_service_id_references_calendar', 'exception_date_valid_yyyymmdd'],
		editable: true,
		group: 'calendar_dates',
	...
	},
	{
		...
		depends_on: ['transfers_valid_gtfs_enum'],
		editable: true,
		group: 'fare_attributes',
	...
	},
	{
		...
		depends_on: ['trip_id', 'start_time', 'end_time'],
		editable: true,
		group: 'frequencies',
	...
	},
	{
		...
		depends_on: ['arrival_time_ordering_with_departure_and_frequencies', 'departure_time_ordering_with_arrival_and_timepoint'],
		editable: true,
		group: 'stop_times',
	...
	},
	{
		...
		depends_on: ['stop_times_trip_id_references_trips_table', 'timepoint_valid_gtfs_enum'],
		editable: true,
		group: 'stop_times',
	...
	},
	{
		...
		depends_on: ['start_pickup_drop_off_window_valid'],
		editable: true,
		group: 'stop_times',
	...
	},
	{
		...
		depends_on: ['location_type_valid_enum'],
		editable: true,
		group: 'stops',
	...
	},
	{
		...
		depends_on: ['location_type_valid_enum', 'stop_id_unique'],
		editable: true,
		group: 'stops',
	...
	},
	{
		...
		depends_on: ['has_shelter_valid_enum'],
		editable: true,
		group: 'stops',
	...
	},
	{
		...
		depends_on: ['parent_station_id_valid_for_stop_hierarchy'],
		editable: true,
		group: 'stops',
	...
	},
	{
		...
		depends_on: ['translations_file_present'],
		editable: true,
		group: 'translations',
		id: 'field_name',
	},
	...
	},
	{
		...
		depends_on: ['pattern_id_trip_has_required_fields_for_grouping', 'direction_id_valid_enum'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_matches_feed_pattern_id_syntax', 'direction_id_valid_enum'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_matches_feed_pattern_id_syntax', 'shape_id_references_shapes_table_when_present'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_trip_has_required_fields_for_grouping', 'shape_id_references_shapes_table_when_present'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_present_and_references_consistent'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_trip_has_required_fields_for_grouping', 'stop_sequence_increasing_by_one_along_trip'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_matches_feed_pattern_id_syntax'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_trip_has_required_fields_for_grouping', 'route_id_references_routes_table'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['shape_id_references_shapes_table_when_present', 'pattern_id_matches_feed_pattern_id_syntax'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['pattern_id_trip_has_required_fields_for_grouping', 'trip_headsign_present_when_short_name_absent'],
		editable: true,
		group: 'trips',
	...
	},
	{
		...
		depends_on: ['shape_id_references_shapes_table_when_present', 'stop_sequence_increasing_by_one_along_trip'],
		editable: true,
		group: 'trips',
