...
const gtfsValidationActions: PermissionConfig = {
	actions: [
		...
		{ action: 'update_publish_status', description: 'Permite alterar o estado de publicação de uma validação', label: 'Alterar estado de publicação', resources: ['AGENCIES'] },
	],
