...
export const RawVehicleEventCmetV1LogPayloadSchema = z.object({
	header: z.object({
...
export type RawVehicleEventCmetV1LogPayload = z.infer<typeof RawVehicleEventCmetV1LogPayloadSchema>;

/* * */

export const RawVehicleEventCmetV1LogSchema = RawVehicleEventBaseSchema.extend({
	payload: RawVehicleEventCmetV1LogPayloadSchema,
	version: z.literal('cmet-v1-log'),
});

export type RawVehicleEventCmetV1Log = z.infer<typeof RawVehicleEventCmetV1LogSchema>;
