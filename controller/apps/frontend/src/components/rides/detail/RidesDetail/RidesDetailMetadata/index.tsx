		...
		<Collapsible description="Informações gerais sobre esta circulação" title="Metadados">
			<Section gap="md">
				<Grid columns="abc" gap="md">
					...
					<ValueDisplay label="Atraso à Partida" value={ridesDetailContext.data.ride?.start_delay_value_display ?? 'N/A'} bordered />
					...
					<ValueDisplay label="Atraso à Chegada" value={ridesDetailContext.data.ride?.end_delay_value_display ?? 'N/A'} bordered />
				</Grid>
			</Section>
			<Divider />
			<Section gap="md">
