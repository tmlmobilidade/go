...
export const RawVehicleEventPtTmpUnirUt4V1PayloadSchema = z.object({
...
export type RawVehicleEventPtTmpUnirUt4V1Payload = z.infer<typeof RawVehicleEventPtTmpUnirUt4V1PayloadSchema>;

/* * */

export const RawVehicleEventPtTmpUnirUt4V1Schema = RawVehicleEventBaseSchema.extend({
	agency_id: z.literal('VZAS3'),
	payload: RawVehicleEventPtTmpUnirUt4V1PayloadSchema,
	version: z.literal('pt-tmp-unir-ut4-v1'),
});

export type RawVehicleEventPtTmpUnirUt4V1 = z.infer<typeof RawVehicleEventPtTmpUnirUt4V1Schema>;
