...
(async function init() {
	...
	try {
		...
		Logger.startNodeLogs({ app: 'pt-tml-tcb-labdb-stream', message: 'Sentry Tracker CRTM AISA LabDb Stream initialized', module: 'tracker', severity: 'info' });
	} catch (error) {
