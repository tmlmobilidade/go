...
/**
 * Converts an array of `HubV1ApiVehiclePosition` objects to a GTFS-RT feed message.
 *
 ...
 *
 * @param positions Array of `HubV1ApiVehiclePosition` objects to convert.
 * @returns The GTFS-RT feed message containing the transformed entity and header.
 */
export function toGtfsRtVehiclePositions(positions: HubV1ApiVehiclePosition[]): GtfsRtFeedMessage {
