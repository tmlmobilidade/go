...
import { type RawVehicleEventPtTmlMobi, type SimplifiedVehicleEvent } from '@tmlmobilidade/go-types-vehicle-events';
...
/**
 * Transforms a newly inserted MOBI RawVehicleEvent into a SimplifiedVehicleEvent
 ...
 */
export async function processRawVehicleEvent(change: ChangeStreamDocument<RawVehicleEventPtTmlMobi>) {
	//
