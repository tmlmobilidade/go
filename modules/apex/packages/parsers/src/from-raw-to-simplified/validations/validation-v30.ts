...
import { type RawApexTransactionValidationV30, type SimplifiedApexValidation } from '@tmlmobilidade/go-types-apex';

/* * */

export function parseRawApexTransactionValidationV30(doc: RawApexTransactionValidationV30): null | SimplifiedApexValidation {
	try {
		//
