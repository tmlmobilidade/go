...
| 15 | Normalize context flags and memoize provider values | in progress | 10–14 | All providers except Route Planner now expose stable values; local boolean flags use snake_case and permanently undefined/false flags were removed. Route Planner remains as a separate behavior-sensitive slice. |
