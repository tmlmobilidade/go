...
import { type OperationRidesV2ExtractionProperties } from '@tmlmobilidade/go-types-extractions';

import { operationRidesV2ExtractionQuery } from './query.js';
...
/**
 * Builds the SQL and the params for a v2 Rides extraction.
 *
 ...
 */
export function getSqlAndParams(properties: OperationRidesV2ExtractionProperties): null | { params: QueryParams, sql: string } {
	//
	...
	const sql = operationRidesV2ExtractionQuery
