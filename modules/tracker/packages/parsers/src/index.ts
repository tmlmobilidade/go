...
interface ParseRawVehicleEventIntoSimplifiedVehicleEventParams {
 ...
 */
export async function parseRawVehicleEventIntoSimplifiedVehicleEvent({ batchWriter, databaseOperation, flushCallback }: ParseRawVehicleEventIntoSimplifiedVehicleEventParams) {
	try {
		//
