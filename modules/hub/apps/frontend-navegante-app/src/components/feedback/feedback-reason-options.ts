...
export const FEEDBACK_LINE_REASON_GROUPS = {
	...
	line_service: {
		...
		options: [
			...
			{ label: 'Capacidade insuficiente', value: 'insufficient_capacity' },
			...
			{ label: 'Problema no painel', value: 'display_issue' },
			{ label: 'Problema nos anúncios sonoros', value: 'audio_announcement_issue' },
			...
			{ label: 'Tempo de viagem excessivo', value: 'excessive_travel_time' },
			{ label: 'Outro', value: 'other' },
		],
	},
	vehicle: {
		...
		options: [
			...
			{ label: 'Incidente de segurança', value: 'safety_incident' },
			{ label: 'Outro', value: 'other' },
		],
	},
...
export const FEEDBACK_STOP_REASON_GROUPS = {
	stop: {
		...
		options: [
			...
			{ label: 'Fila desorganizada', value: 'disorganized_boarding' },
			{ label: 'Problema de acessibilidade', value: 'accessibility_issue' },
			{ label: 'Problema no elevador ou escada rolante', value: 'elevator_escalator_issue' },
			{ label: 'Problema no passeio', value: 'sidewalk_issue' },
			{ label: 'Problema no validador', value: 'validator_issue' },
			{ label: 'Sinalética confusa', value: 'confusing_signage' },
			{ label: 'Banco danificado', value: 'damaged_bench' },
			{ label: 'Problema no abrigo', value: 'shelter_issue' },
			{ label: 'Sem caixote do lixo', value: 'no_trash_bin' },
			{ label: 'Exposição ao mau tempo', value: 'weather_exposure_issue' },
			{ label: 'Incidente de segurança', value: 'safety_incident' },
			{ label: 'Outro', value: 'other' },
		],
	},
